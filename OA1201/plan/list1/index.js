  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control36_1TMe5I: function (elem) {
      ...
      if (data.eventType == 'handleClassTwo') {
        ...
        // elem.ownerDocument.defaultView.parent.document.querySelector('frame:nth-child(2)').contentWindow.location.href = 'http://oa.jx-bank.com/weboa/windex.nsf/frmcenter?openform';
