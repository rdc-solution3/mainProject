(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control96_XlM2HL: function (elem) {
      if (elem) {
    ...
    doAction_uiControl99_6Nvtxi: function (data, elem) {
    ...
    getTemplate_uiControl99_6Nvtxi: function () {
    ...
    getData_control126_tACuoN: function (elem) {},
    doAction_uiControl135_qTbM0l: function (data, elem) {
      if (data.eventType == 'handleBtnClick') {
        $(elem).children().children().find('input')[+data.dataCustom].click();
      }
    },
    getTemplate_uiControl135_qTbM0l: function () {
