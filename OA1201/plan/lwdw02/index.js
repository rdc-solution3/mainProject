(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control109_FFoIz8: function (elem) {
      if (elem) {
    ...
    doAction_uiControl112_ntxOXo: function (data, elem) {
    ...
    getTemplate_uiControl112_ntxOXo: function () {
    ...
    getData_control111_NXVRRf: function (elem) {},
    doAction_uiControl115_1htgWh: function (data, elem) {
      if (data.eventType == 'handleBtnClick') {
        $(elem).children().children().find('input')[+data.dataCustom].click();
      }
    },
    getTemplate_uiControl115_1htgWh: function () {
