  ...
  utils.extend(ysp.customHelper, {
    ...
    */
    ...
    onTargetLoad: function(aWin, doc){
			if(aWin.hideProgress){
        var _hideProgress = aWin.hideProgress;
        aWin.hideProgress = function () {
        	_hideProgress();
        	try{ysp.appMain.hideLoading();}catch(e){}
				};
			}
			if(aWin.showProgress){
        var _showProgress = aWin.showProgress;
        aWin.showProgress = function(){
        	_showProgress();
          try{ysp.appMain.showLoading();}catch(e){}
        }
			}
    },
