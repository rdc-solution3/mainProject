  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl43_k30oZ9: function (data, elem) {
      if (data.eventType === 'click') {
        ...
        /**
        	<root>
            <business appid="CREDIT" tradecode="JKDS" optiontype="1" tradedate="20171223" tradeuser="cot" objname="XYZ" objpart="XYZ_PART" user="admin" pwd="111" objtoken="" isenc="0" organ="" ip="10.1.44.21" port="9080" dsname="">
        ...
        <root>
          <business appid="CREDIT" tradecode="JKDS" optiontype="1" tradedate="20171206" tradeuser="cot" objname="GRXD" objpart="GRXD_PART" user="admin" pwd="111" objtoken="" isenc="0" organ="" ip="10.1.44.21" port="9080" dsname="">
              <node theme="GRKH" batchid="">
        ...
        <root>
          <business appid="CREDIT" tradecode="JKDS" optiontype="1" tradedate="20180317" tradeuser="cot" objname="GRXD" objpart="GRXD_PART" user="admin" pwd="111" objtoken="" isenc="0" organ="" ip="10.1.44.21" port="9080" dsname="">
            <node theme="GRKH" batchid="">
        ...
        生产环境IP：10.1.8.76
        测试环境&UAT-IP：10.1.44.21
        // alert(seriaNo + '+' + queryTime);
        // console.log(tradeInfoArg);
        获取——tradedate,批次号，日期**/var seriaNo = elem.querySelector('#seriaNo').value;var queryTime = elem.querySelector('#queryTime').value;var tradeInfoArg = '<root><business appid="CREDIT" tradecode="JKDS" optiontype="1" tradedate="' + queryTime + '" tradeuser="cot" objname="GRXD" objpart="GRXD_PART" user="admin" pwd="111" objtoken="" isenc="0" organ="" ip="10.1.44.21" port="9080" dsname=""><node theme="GRKH" batchid="" version="0"><bsinf attr="BUSI_SERIAL_NO" disp="批次号" isquery="1">' + seriaNo + '</bsinf><bsinf attr="BUSI_START_DATE" disp="日期" isquery="1">' + queryTime + '</bsinf></node></business></root>';yspCheckIn.openImageSys('CREDIT', 'JKDS', tradeInfoArg);
      }
    },
