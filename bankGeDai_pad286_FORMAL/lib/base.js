        ...
        if(/pageName=login/.test(_url)){
          if(top.switch===undefined){
            try{
              ...
              setTimeout(function(){
                top.switch="done";
                ysp.appMain.getActiveWindow().location.href = "http://10.1.24.207:7001/grxd";
    ...
    beforeTargetLoad: function(aWin, doc) {
      ...
      if(aWin.frameElement.name && aWin.frameElement.name==="businessfrm"){
        ...
        aWin.onload=function(){
          ...
          //   aWin.location.href="http://10.1.24.207:7001/grxd/cldloanapply/CldApplyAction.do?button_method=create";
          // }else 
